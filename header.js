...
let left_sidebar_top = `<h5 class="brand-name">S S Agrawal </br>ERP System<a href="javascript:void(0)" class="menu_option float-right"><i class="icon-grid font-16" data-toggle="tooltip" data-placement="left" title="Grid & List Toggle"></i></a></h5>
...
<div class="tab-content mt-3">
    <div class="tab-pane fade show active" id="menu-uni" role="tabpanel">
        <nav class="sidebar-nav">
            <ul class="metismenu">`
let left_sidebar_bottom = `</ul>
</nav>
</div>
</div>`;
let left_sidebar_student = `<li><a href="students_dashboard.html"><i class="fa fa-dashboard"></i><span>Student Dashboard</span></a></li>
<li><a href="students_view.html"><i class="fa fa-users"></i><span>Students</span></a></li>`;
let left_sidebar_admin = `<li><a href="admin_dashboard.html"><i class="fa fa-dashboard"></i><span>Admin Dashboard</span></a></li>
...
let left_sidebar = left_sidebar_top;
if (userData.role == "student") {
    left_sidebar += left_sidebar_student;
} else if (userData.role == "admin") {
    left_sidebar += left_sidebar_admin;
}
left_sidebar += left_sidebar_bottom;
